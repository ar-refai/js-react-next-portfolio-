          ...
          <motion.div>
            <div className="py-6 flex flex-col justify-center sm:py-12 ">
              <div className="relative group py-3 sm:max-w-xl sm:mx-auto ">
                {/* THE UNDER CARD #1 */}
                <motion.div
                  className="absolute px-2 inset-0 bg-gradient-to-r from-sky-800 opacity-50 to-sky-900 shadow-lg transform group-hover:rotate-6  rounded-lg sm:rounded-3xl duration-200 ease-out transition-all">
                </motion.div>
                {/* THE UNDER CARD #2 */}
                <motion.div
                  className="absolute px-2 inset-0 bg-gradient-to-r from-sky-900 opacity-50 to-sky-800 shadow-lg transform group-hover:rotate-12 rounded-lg sm:rounded-3xl duration-200 ease-out transition-all">
                </motion.div>
                {/* THE UPPER CARD */}
                <motion.div className="text-white px-6 md:px-8 relative py-10 bg-gradient-to-br from-sky-700 to-sky-900 shadow-lg rounded-lg sm:rounded-3xl sm:p-20 duration-200 ease-out transition-all group-hover:rotate-2">
