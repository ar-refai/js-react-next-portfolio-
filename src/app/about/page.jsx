            ...
            <div className="">
              ...
              <div className="w-1/6 flex justify-center">
                ...
                <div className=" w-1 h-[500px] bg-gray-700 rounded relative">
                  {/* LINE CIRCLE */}
                  <div className="absolute w-3 h-3 rounded-full ring-4 ring-gray-700 top-[0] -left-1 bg-red-300"></div>
                  <div className="absolute w-3 h-3 rounded-full ring-4 ring-gray-700 top-[250px] -left-1 bg-red-300"></div>
                  <div className="absolute w-3 h-3 rounded-full ring-4 ring-gray-700 bottom-[0] -left-1 bg-red-300"></div>
                </div>
              </div>
              {/* RIGHT */}
